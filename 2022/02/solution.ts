...
const findAnswers = (entries: string[][]) => {
  ...
  // Part One
  const entries_parsed = entries.map(e => {
  ...
  entries_parsed.forEach(e => {
    if (e[1] === 'A') answers.a += 1
    if (e[1] === 'B') answers.a += 2
    if (e[1] === 'C') answers.a += 3

    if (e[0] === e[1]) answers.a += 3
    if (e[0] === 'A' && e[1] === 'B') answers.a += 6
    if (e[0] === 'B' && e[1] === 'C') answers.a += 6
    if (e[0] === 'C' && e[1] === 'A') answers.a += 6
  })

  // Part 2
  answers.b = entries.map(e => {
    let total = 0
    if (e[1] === 'X') {
      if (e[0] === 'A') total += 3
      if (e[0] === 'B') total += 1
...
const testPart1 = async (input: string): Promise<boolean> => {
  ...
  return answers.a === 15 ? true : false;
};
...
const testPart2 = async (input: string): Promise<boolean> => {
  ...
  return answers.b === 12 ? true : false;
};
